...
_reactDom2.default.render(_react2.default.createElement(_View2.default, null), document.getElementById('content'));
...
var View = function (_React$Component) {
  ...
  _createClass(View, [{
    ...
    value: function componentDidMount() {
      ...
      _superagent2.default.get('/getList').end(function (err, res) {
        _this2.setState({ list: JSON.parse(res.text) });
      });
    }
  }, {
    ...
    value: function handleSubmitClick() {
      ...
      _superagent2.default.post('/updateList').send({ "value": this.state.inputValue }).end(function (err, res) {
        _this3.setState({ list: JSON.parse(res.text), inputValue: "" });
      });
    }
  }, {
    key: 'onClick',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_Input2.default, { value: this.state.inputValue, onInputChange: this.handleInputChange.bind(this), onSubmitClick: this.handleSubmitClick.bind(this) }),
        _react2.default.createElement(_List2.default, { data: this.state.list }),
        _react2.default.createElement('input', { type: 'reset', onClick: this.onClick.bind(this) })
      );
    }
  }]);
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement("input", { type: "text", value: this.props.value, onChange: this.props.onInputChange }),
        _react2.default.createElement("input", { type: "submit", onClick: this.props.onSubmitClick })
      );
    }
  }]);
